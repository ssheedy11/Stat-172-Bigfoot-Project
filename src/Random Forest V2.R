...
#holding other observation characteristics constant, if the observer's description fit more into the Describing creatures category
#their odds of their observation being considered Class A increase by a factor of 138.3264 
#by a factor of e(10.882655*.1) = 2.9. That is the odds of winning almost triple.
